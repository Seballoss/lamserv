...
function add (customer) {
  const sql = 'insert into customers (id, phone, phone_at, email, email_at) values ($1, $2, now(), $3, now()) returning *'
  return db.one(sql, [uuid.v4(), customer.phone, customer.email])
...
module.exports = {add, get, getByEmail, batch, getById, update, updatePhotoCard}
